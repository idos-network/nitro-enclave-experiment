 ...
 */
export async function faceSignWalletLogin(
  ...
  if (results.length === 0 && !enrollIfNew) {
    ...
    agent.writeLog("facesign-wallet-user-pending-confirmation", {
  ...
  agent.writeLog("facesign-wallet-new-user", { identifier: currentUserId });

...
sed -i "s#export const RELAY_JWT_PUBLIC_KEY = \"INSERT YOUR RELAY JWT PUBLIC KEY PATH HERE\";#export const RELAY_JWT_PUBLIC_KEY = \"${RELAY_JWT_PUBLIC_KEY//&/\\&}\";#" $HOME_FACESIGN_SERVICE/env.ts

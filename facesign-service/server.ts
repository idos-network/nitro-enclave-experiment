...
import {
  confirmation as faceSignWalletConfirmation,
  login as faceSignWalletLogin,
...
app.post("/facesign-wallet", asyncHandler(faceSignWalletLogin));
app.post("/facesign-wallet/confirmation", asyncHandler(faceSignWalletConfirmation));
